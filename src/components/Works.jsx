...
import cellra from '../assets/cellra.png'
...
{/* Container */}
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
          ...
          <div
            style={{ backgroundImage: `url(${cellra})` }}
            className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div'
          >
            {/* Hover Effects */}
            <div className='opacity-0 group-hover:opacity-100 flex justify-center items-center flex-col'>
              <span className=' text-lg font-bold text-white tracking-wider'>
                cellra- cellular radiation effects Application
              </span>
              <p className='text-center'>A CBT web application built with Java script and Web api, Bootstrap</p>
              <div className='pt-8 text-center'>
                <a href='/'>
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Demo
          ...
          >
            ...
            <div className='opacity-0 group-hover:opacity-100 flex justify-center items-center flex-col'>
              <span className=' text-lg font-bold text-white tracking-wider'>
                Plants Order Application
              </span>
              <p className='text-center'>A CBT web application built with React </p>
              <div className='pt-8 text-center'>
                <a href='/'>
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Demo
